...
int main()
{
    ...
    int pathChoice, actionChoice, puzzleAnswer, actionInVault, treasureChest;

    int actionInSwamp;

    scanf("%d", &pathChoice);
    // scanf("%d", &actionChoice);
    // scanf("%d", &actionInSwamp);
